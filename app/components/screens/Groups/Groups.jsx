    ...
    return (
        <LeftIntro>
            <div className={styles.groups}>
                ...
                ></div>
                <button onClick={() => setAddGroup(true)} className={styles.groups__btn} type='button'>Yangisnini qo'shish</button>
                <div className={styles.groups__search}>
                    <div className={styles.groups__search__select}>
                        <Select
                            name="status"
                    ...
                    <button className={styles.groups__search__btn}>Filterlash</button>
                </div>
                <div className={styles.groups__items}>
                    <div className={styles.groups__items__table}>
                        <div className={styles.groups__items__table__header}>
                            <b>Guruh</b>
                            <b>O'qituvchi</b>
                            <b>Kunlar</b>
                        ...
                        <div className={styles.groups__items__table__body}>
                            {!loader ? (
                                data?.map((item, key) => (
                ...
                <div className={styles.groups__pagination}>
                    <button
                        className={styles.groups__pagination__btn}
                    ...
                    {Array.from({ length: itemsPerPage }, (_, index) => index + 1).map(
                        (page) => (
                            <button
                                className={`${styles.groups__pagination__items} ${currentPage === page ? styles.act : ""
                                    }`}
                                key={page}
                ...
                <div className={`${styles.groups__register} ${addSGroup ? styles.registerAct : ""}`}>
                    <div style={{ display: addSGroup ? '' : 'none' }} className={styles.groups__register__list}>
                        <div className={styles.groups__register__list__header}>
                            <p>Guruh qo'shish</p>
                            <i onClick={() => setAddGroup(false)} className="fa-solid fa-x"></i>
                        </div> <form className={styles.groups__register__list__form} onSubmit={handleSubmit}>
                            <label htmlFor="name">
                                <p>Nomi</p>
                                <input
                                    type="text"
