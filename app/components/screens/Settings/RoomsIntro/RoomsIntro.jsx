import styles from './RoomsIntro.module.scss'
    ...
    return (
        <LeftIntro>
            <div className={styles.roomsIntro}>
                ...
                ></div>
                <button onClick={() => setAddRoom(true)} className={styles.roomsIntro__btn} type='button'>Yangisnini qo'shish</button>
                <div className={styles.roomsIntro__items}>
                    <div className={styles.roomsIntro__items__table}>
                        <div className={styles.roomsIntro__items__table__header}>
                            <b>№</b>
                            <b>Nomi</b>
                            <b></b>
                        </div>

                        <div className={styles.roomsIntro__items__table__body}>
                            {!loader ? (
                                data?.map((item, key) => (
                                    <div key={key} className={styles.roomsIntro__items__table__body__item}>
                                        <p>
                ...
                <div
                    className={`${styles.roomsIntro__register} ${addRoom ? styles.registerAct : ''}`}
                >
                    <div
                        style={{ display: addRoom ? '' : 'none' }}
                        className={styles.roomsIntro__register__list}
                    >
                        <div className={styles.roomsIntro__register__list__header}>
                            <p>Xona qo'shish</p>
                            <i onClick={() => setAddRoom(false)} className="fa-solid fa-x"></i>
                        </div>
                        <form
                            className={styles.roomsIntro__register__list__form}
                        >
                            <label>
                                <p>Xona nomi:</p>
                                <input
